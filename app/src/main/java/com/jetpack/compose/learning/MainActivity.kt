...
import com.jetpack.compose.learning.sharedelementtransition.SharedElementTransitionActivity
...
class MainActivity : ComponentActivity() {
    ...
    private fun getComponents() = listOf(
        ...
        Component("Shared Element Transition API", SharedElementTransitionActivity::class.java)
    )
}