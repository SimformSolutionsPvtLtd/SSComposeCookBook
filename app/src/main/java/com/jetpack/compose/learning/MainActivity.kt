...
import com.jetpack.compose.learning.sharedelementtransition.activity.SharedElementTransitionActivity
...
class MainActivity : ComponentActivity() {
    ...
    private fun getComponents() = listOf(
        ...
        Component("Shared Element Transition", SharedElementTransitionActivity::class.java)
    )
}