            ...
            TabRow(selectedTabIndex = tabIndex,
                ...
                tabList.forEachIndexed { index, tab ->
                    Tab(selected = index == tabIndex,
                        ...
                        text = {
                            Text(tab.first, color = Color.White)
                        },
                        icon = {
                            tab.second
                        }
            ...
            HorizontalPager(
                ...
                Text(
                    when (this.currentPage) {
                        0 -> stringResource(id = R.string.description_music)
                        1 -> stringResource(id = R.string.description_market)
                        2 -> stringResource(id = R.string.description_films)
                        else -> stringResource(id = R.string.description_books)
                    },
                    modifier = Modifier
                        .fillMaxSize()
                        .padding(10.dp)
